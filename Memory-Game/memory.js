class AudioController {
  constructor() {
    this.mrMusic = new Audio("MrBeast.mp3");
    ...
    this.mrMusic.volume = 0.5;
    this.mrMusic.loop = true;
  }
  startMusic() {
    this.mrMusic.play();
  }
...
function ready() {
  ...
  let game = new MrBeastMemoryGame(100, cards);
